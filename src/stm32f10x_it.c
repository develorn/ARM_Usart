...
void SysTick_Handler(void)
{
	...
	//TEST temporary moved as in original
	//LED_USB_On(); 						//turn on USB diode
	//inj_handle_temp_measurement(); 	// Send temperature frame	//TEST temporarily turn off
	//inj_handle_current_measurement(); // Send current frame		//TEST temporarily turn off
